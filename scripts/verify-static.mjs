...
const requiredFiles = ['dist/index.html', 'dist/assets', 'dist/manifest.webmanifest', 'dist/robots.txt', 'dist/sitemap.xml', 'dist/build.json', 'public/_headers', 'netlify.toml']
...
if (!buildInfo.commit || !buildInfo.builtAt) {
...
const appAssertions = ['skip-link', 'description-toggle', 'share-solve', 'next-puzzle', 'data-testid="feedback"']
