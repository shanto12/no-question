...
Release source verified: `2853b331e496a7a2de25b49d679fab5f2a8ba53c`
Production URL: https://no-question.netlify.app
Netlify deploy: `6a79105e821d4e86a1f2b186`
...
| Local production build | Terminal | PASS | `npm run verify` passed on release source; build identity recorded in `dist/build.json` |
...
| Production deployment | Netlify CLI + live build manifest | PASS | Site `no-question`, deploy `6a79105e821d4e86a1f2b186`; `/build.json` reports the release source SHA |
